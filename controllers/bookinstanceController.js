...
exports.bookinstance_update_get = function(req, res, next) {
    // Get title, imprint and and status for form.
    async.parallel({
        ...
        books: function(callback) {
            ...
            res.render('bookinstance_form', { title: 'Update Book instances', book_list : results.books, selected_book : results.bookinstance.book._id, bookinstance: results.bookinstance });
        });
};
